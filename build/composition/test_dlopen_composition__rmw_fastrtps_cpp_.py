...
def generate_test_description():
    ...
    process_under_test = ExecuteProcess(
        cmd=[
            '/home/colbren/ground-station/build/composition/dlopen_composition',
            '/home/colbren/ground-station/build/composition/libtalker_component.so',
            '/home/colbren/ground-station/build/composition/liblistener_component.so',
            '/home/colbren/ground-station/build/composition/libserver_component.so',
            '/home/colbren/ground-station/build/composition/libclient_component.so'
        ],
