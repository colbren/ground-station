...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen',
            env=env)
        for i, executable in enumerate('/home/colbren/ground-station/build/demo_nodes_cpp/parameter_events_async'.split(';'))
    ]
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/colbren/ground-station/src/demos/demo_nodes_cpp/test/parameter_events_async'.split(';')
