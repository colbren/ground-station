...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen',
            env=env)
        for i, executable in enumerate('/home/colbren/ground-station/build/demo_nodes_cpp/content_filtering_publisher;/home/colbren/ground-station/build/demo_nodes_cpp/content_filtering_subscriber'.split(';'))
    ]
