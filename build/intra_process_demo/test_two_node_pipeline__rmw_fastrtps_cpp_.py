...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen'
        ) for i, executable in enumerate('/home/colbren/ground-station/build/intra_process_demo/two_node_pipeline'.split(';'))
    ]
...
class TestExecutablesDemo(unittest.TestCase):
    ...
    def test_executables_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/colbren/ground-station/src/demos/intra_process_demo/test/two_node_pipeline'.split(';')
